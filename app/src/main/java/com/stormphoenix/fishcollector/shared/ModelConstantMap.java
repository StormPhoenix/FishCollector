...
public class ModelConstantMap {
    ...
    public static final ModelHolder DOMINANT_PHYTOPLANKTON_SPECIES_HOLDER = new ModelHolder(ModelNames.DOMINANT_PHYTOPLANKTON_SPECIES_NAME, R.string.ic_folder, "hello", null);
    public static final ModelHolder DOMINANT_ZOOPLANKTON_SPECIES_HOLDER = new ModelHolder(ModelNames.DOMINANT_ZOOPLANKTON_SPECIES_NAME, R.string.ic_folder, "hello", null);
